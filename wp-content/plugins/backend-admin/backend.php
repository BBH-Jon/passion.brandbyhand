...
function customer_logo_function() {
    if (get_custom_logo()) {
...
add_shortcode('customer_logo', 'customer_logo_function');

function bbh_logo_function() {
    return '<a href="https://brandbyhand.dk"><img src="' . plugins_url( 'images/bbh_logo.png' , __FILE__ ) . '"></img></a>';
}
add_shortcode('bbh_logo', 'bbh_logo_function');

function bbh_text_function() {
    return '<p>'.get_bloginfo('name').' / Brand by Hand</p>';
}
add_shortcode('bbh_text', 'bbh_text_function');
