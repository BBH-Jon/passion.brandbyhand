<form action="<?php echo site_url() ?>/wp-admin/admin-ajax.php" method="POST" id="filter">
    ...
    <?php // nonce security; ?>
    <input type="hidden" name="security" id="ebooks-ajax-nonce" value="<?php echo wp_create_nonce( 'ebooks-ajax-nonce' ) ?>"/><!-- "id'et" går igen i wp_create_nonce og igen i din ajax fil -->
<!-- The below input value must be called the same as your ajax function. -->
    <input type="hidden" name="action" value="ebooks_ajax">
</form>
